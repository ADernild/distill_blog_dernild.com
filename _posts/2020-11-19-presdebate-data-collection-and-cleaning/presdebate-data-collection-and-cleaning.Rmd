...
library(bibtex)
libraries <- c("rtweet") 
write.bib(libraries, file = "Rpackages.bib")
```

### Configuring application and access token to connect to Twitter API
...
![Configuring application on Twitter Developer Portal](images/twitterApp1.png) ![Configuring application on Twitter Developer Portal, making sure the callback URL is set to 127.0.0.1:1410](images/twitterApp2.png) *Figure 1.1 Configuring application on Twitter Developer Portal*
